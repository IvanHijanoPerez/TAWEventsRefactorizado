...
<html>
    ...
    <body>
        ...
        <div class="signup-form">
            ...
            <form method="POST" action="ServletInicioAutenticar">
                ...
                <a style="text-align:center;display:block;" href="crearEditarUsuarioDeEventos.jsp">Crear cuenta en TAWEvents</a>
            </form>
